...
$config = array(
    ...
    */
    ...
    |
    */
    'upload_dir' => ABSPATH.'wp-content/uploads/krflmd/',
    /*
    |--------------------------------------------------------------------------
    ...
    |
    */
    'current_path' => ABSPATH.'wp-content/uploads/krflmd/',
    ...
    |
    */
    'thumbs_base_path' => '.tmb/',
    'thumbs_base_url' => '/wp-content/uploads/krflmd/',
    ...
    */
    ...
    | If you use kristallConnectTmflp tinymce extension can copy into editor multiple object like images, videos, audios, links in the same time
    |
     */
    ...
    *******************/
    ...
    // main icons
    'menu.normalIcon.path'                 => '/wp-content/plugins/kristall-integration/connector/assets/images/connector_sub/svg/icon-d.svg',
    'menu.normalIcon.name'                 => 'icon-d',
    'menu.activeIcon.path'                 => '/wp-content/plugins/kristall-integration/connector/assets/images/connector_sub/svg/icon-b.svg',
    'menu.activeIcon.name'                 => 'icon-b',
    'menu.disabledIcon.path'               => '/wp-content/plugins/kristall-integration/connector/assets/images/connector_sub/svg/icon-a.svg',
    'menu.disabledIcon.name'               => 'icon-a',
    'menu.hoverIcon.path'                  => '/wp-content/plugins/kristall-integration/connector/assets/images/connector_sub/svg/icon-c.svg',
    ...
    // submenu icons
    'submenu.normalIcon.path'              => '/wp-content/plugins/kristall-integration/connector/assets/images/connector_sub/svg/icon-d.svg',
    'submenu.normalIcon.name'              => 'icon-d',
    'submenu.activeIcon.path'              => '/wp-content/plugins/kristall-integration/connector/assets/images/connector_sub/svg/icon-b.svg',
