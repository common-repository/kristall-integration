...
try {
    ...
    include $path_lib.'include/mime_type_lib.php';
    ...
    require($path_lib.'UploadHandler.php');
    $messages = null;
    ...
    $postUrl = sanitize_text_field($_POST['url']);
	if (isset($postUrl) && strlen($postUrl) < 2000) {
        $url = $postUrl;
        ...
        if (preg_match($urlPattern, $url)) {
            ...
            $_FILES['files'] = array(
                'name' => array(basename(sanitize_text_field($_POST['url']))),
                'tmp_name' => array($temp),
